...
const mockProjects: Project[] = [
  {
    ...
    description: `## Overview\n\nMonthly home visits delivering maternal health education, postnatal support, and child nutrition guidance to over 400 families across Onitsha South.\n\nSince launching in 2024, we have reached 412 families and seen a 34% reduction in childhood malnutrition in our target communities.`,
    coverImage: null,
    goalAmount:    12000000,
    ...
    updates: [
      { id: "upd1", projectId: "p1", title: "Q1 2026 Progress", content: "412 families reached this quarter.", image: null, createdAt: "2026-02-01T00:00:00Z" },
    ],
  ...
  },
  {
    ...
    description: `## Overview\n\nProviding primary and secondary school scholarships, learning materials, and mentorship to children from low-income households in Anambra State.\n\n340 scholarships awarded in year one with a 97% retention rate.`,
    coverImage: null,
    goalAmount:    18000000,
    ...
    isFeatured: true,
    createdById: "u2",
    createdBy: { id: "u2", firstName: "Chidi", lastName: "Ezenwachi", email: "chidi@eleje.ng" },
    updates: [],
  ...
  },
  {
    ...
    isFeatured: false,
    createdById: "u3",
    createdBy: { id: "u3", firstName: "Ngozi", lastName: "Umezurike", email: "ngozi@eleje.ng" },
    updates: [],
  ...
  },
  {
    ...
    description: `## Overview\n\nTraining and deploying 60 community health workers drawn from target communities to serve as the first point of contact for maternal and child health needs across Onitsha, Ogbaru, and Ekwusigo.`,
    coverImage: null,
    goalAmount:   5000000,
    ...
    createdBy: { id: "u1", firstName: "Amara", lastName: "Okonkwo", email: "amara@eleje.ng" },
    updates: [
      { id: "upd2", projectId: "p5", title: "Programme Complete", content: "All 60 CHWs certified and deployed.", image: null, createdAt: "2025-07-01T00:00:00Z" },
    ],
  ...
  },
  {
    ...
    isFeatured: false,
    createdById: "u4",
    createdBy: { id: "u4", firstName: "Ifeanyi", lastName: "Agu", email: "ifeanyi@eleje.ng" },
    updates: [],
    ...
    <>
      <PageBanner
        ...
        title={
          <>
            Change that you can{" "}
            <em style={{ fontStyle: "italic", color: "var(--glow)" }}>see and measure.</em>
          </>
        }
        minHeight="38vh"
      />
            ...
            <Link href={`/project/${highlightProj.slug}`}>
              ...
              >
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(140deg, var(--deep) 0%, var(--emerald) 60%, #34D399 100%)" }}
                >
                  ...
                  <svg className="absolute bottom-6 right-6 opacity-10"
                    width="140" height="160" viewBox="0 0 60 68" fill="white">
                  ...
                  {highlightProj.updates[0] && (
                    <div className="relative z-10 flex items-center gap-2 px-3 py-2 rounded-[6px]"
                      style={{ background: "rgba(0,0,0,0.3)", backdropFilter: "blur(8px)" }}>
                      <span className="w-[5px] h-[5px] rounded-full flex-shrink-0" style={{ background: "var(--glow)" }} />
                      <span className="text-[0.58rem] tracking-wide" style={{ color: "rgba(255,255,255,0.7)" }}>
                  ...
                  <div className="mb-6">
                    <div className="flex justify-between mb-2">
                      ...
                      <span style={{ fontSize: "0.75rem", color: "var(--mid)", fontWeight: 600 }}>
                        {progressPercent(highlightProj.currentAmount, highlightProj.goalAmount)}% of goal
                      </span>
                    </div>
                    <div className="w-full rounded-full h-[6px]" style={{ background: "var(--warm2)" }}>
                      <div
                    ...
                    <div className="mt-1" style={{ fontSize: "0.62rem", color: "var(--mgrey)" }}>
